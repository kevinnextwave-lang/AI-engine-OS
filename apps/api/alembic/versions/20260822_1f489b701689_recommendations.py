...
def upgrade() -> None:
    ...
    sa.UniqueConstraint('project_id', 'source_key', name='uq_recommendations_project_source_key')
    )
    op.create_index('ix_recommendations_opportunity_score', 'recommendations', ['opportunity_score'], unique=False)
    op.create_index('ix_recommendations_priority', 'recommendations', ['priority'], unique=False)
    op.create_index('ix_recommendations_project_id', 'recommendations', ['project_id'], unique=False)
